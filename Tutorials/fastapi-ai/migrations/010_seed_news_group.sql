...
SELECT id, '00000000-0000-4000-8000-000000000001', NULL, title, body, created, created
FROM (
    SELECT '00000000-0000-4000-8000-000000000101' AS id,
           'Welcome to News' AS title,
           'This is the place for announcements. Follow the group to see new posts in your timeline.' AS body,
           strftime('%Y-%m-%dT%H:%M:%SZ', 'now', '-45 days') AS created
    UNION ALL SELECT '00000000-0000-4000-8000-000000000102',
           ...
           strftime('%Y-%m-%dT%H:%M:%SZ', 'now', '-38 days')
    UNION ALL SELECT '00000000-0000-4000-8000-000000000103',
           ...
           strftime('%Y-%m-%dT%H:%M:%SZ', 'now', '-31 days')
    UNION ALL SELECT '00000000-0000-4000-8000-000000000104',
    ...
    UNION ALL SELECT '00000000-0000-4000-8000-000000000105',
           ...
           strftime('%Y-%m-%dT%H:%M:%SZ', 'now', '-19 days')
    UNION ALL SELECT '00000000-0000-4000-8000-000000000106',
    ...
    UNION ALL SELECT '00000000-0000-4000-8000-000000000107',
    ...
    UNION ALL SELECT '00000000-0000-4000-8000-000000000108',
...
SELECT id, post_id, parent_id, NULL, body, created, created
FROM (
    SELECT '00000000-0000-4000-8000-000000000201' AS id,
           '00000000-0000-4000-8000-000000000102' AS post_id,
           NULL AS parent_id,
           'Great news, the ring road has been dangerous for years.' AS body,
           strftime('%Y-%m-%dT%H:%M:%SZ', 'now', '-37 days') AS created
    UNION ALL SELECT '00000000-0000-4000-8000-000000000202', '00000000-0000-4000-8000-000000000102', '00000000-0000-4000-8000-000000000201',
           'Agreed. I hope they add bike parking at the station too.',
           strftime('%Y-%m-%dT%H:%M:%SZ', 'now', '-36 days')
    UNION ALL SELECT '00000000-0000-4000-8000-000000000203', '00000000-0000-4000-8000-000000000102', NULL,
           'Does anyone know which streets are first?',
           strftime('%Y-%m-%dT%H:%M:%SZ', 'now', '-35 days')
    UNION ALL SELECT '00000000-0000-4000-8000-000000000204', '00000000-0000-4000-8000-000000000103', NULL,
           'The error messages alone make it worth upgrading.',
           strftime('%Y-%m-%dT%H:%M:%SZ', 'now', '-30 days')
    UNION ALL SELECT '00000000-0000-4000-8000-000000000205', '00000000-0000-4000-8000-000000000109', NULL,
           'Rereading The Hobbit with my kids. Still wonderful.',
           strftime('%Y-%m-%dT%H:%M:%SZ', 'now', '-1 days')
    UNION ALL SELECT '00000000-0000-4000-8000-000000000206', '00000000-0000-4000-8000-000000000109', '00000000-0000-4000-8000-000000000205',
           'Such a good one to read aloud.',
           strftime('%Y-%m-%dT%H:%M:%SZ', 'now', '-1 days', '+3 hours')
    UNION ALL SELECT '00000000-0000-4000-8000-000000000207', '00000000-0000-4000-8000-000000000109', NULL,
           'Working through a history of the printing press. Surprisingly gripping.',
           strftime('%Y-%m-%dT%H:%M:%SZ', 'now', '-20 hours')
    UNION ALL SELECT '00000000-0000-4000-8000-000000000208', '00000000-0000-4000-8000-000000000108', NULL,
