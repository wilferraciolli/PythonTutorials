...
`src/app/shared/…`); the code blocks below are copies. When you change a shared
partial in the app, update it here in the same commit.
...
**`src/app/shared/destinations.ts`** (the example list is illustrative; declare your own)
